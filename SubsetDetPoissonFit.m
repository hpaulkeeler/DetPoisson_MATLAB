...
if T>(size(ppStructPoisson,1))
    %(size(ppStructPoisson,1)) is the total number of possible 
...
for tt=1:T    
    ...
    subIndex=indexCellSub{tt}; %index for sub point process
